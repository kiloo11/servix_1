  ...
  <section class="view active">
    ...
    <div class="provider-grid" v-if="app.providers.length">
      <article v-for="provider in app.providers" :key="provider.id" class="provider-card" :style="app.providerStyle(provider)">
        ...
        <span v-if="app.providerRecommendedPaymentDate(provider.id)" class="stat-card-sub">{{ app.t("providers.recommendedPayment", { date: app.formatDateTime(app.providerRecommendedPaymentDate(provider.id)) }) }}</span>
